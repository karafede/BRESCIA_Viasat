...
# engine = sal.create_engine('postgresql://postgres:superuser@10.0.0.1:5432/connect_HAIG_Viasat_BS')
...
## grouping also includes hours in order to query different hours.....
...
all_counts_uv.to_csv('D:\\Federico\\FCDapp\\matched_routes_BRESCIA_2019_03_14.csv')
