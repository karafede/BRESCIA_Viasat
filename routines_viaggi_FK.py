...
def Tab_Completa(dati1v, Fl_Viag):
    # ==========================================================================
...
def Setta_Soste_Generiche_Notte_e_Giorno(dati1v):
    # ==========================================================================
...
def Calcola_Coord_Lavori(_Sosta_Lav_Min, dati1v):
    # ==========================================================================
    #
...
def Calcola_Coord_Lavori(dati1v, _Sosta_Lav_Min):
    # ==========================================================================
    #
    #    T R O V A  coordinate   PRIMO e SECONDO LAVORO
    #
...
def Setta_Soste_Specifica(dati1v, Fine_Sosta_Generica, \
...
def Crea_df_Viaggi_1_Veicolo(dati1v, Fl_Viag):
    # ==========================================================================
...
def Aggiungi_1Veic_ai_Vett_di_INFO_Veic(dati1v,N_Presenze_Giornaliere_Reali, N_Case, N_Lavori,
...
def Aggiungi_1Veic_Eliminato(Id_veic_elim, dati1v, Reg_veic_elim, Causa_veic_elim,
                             Veic_da_Eliminare, Causa_eliminaz, _N_elim):
    # ==========================================================================
