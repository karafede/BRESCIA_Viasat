...
with open("D:/ENEA_CAS_WORK/BRESCIA/all_idterms.txt", "w") as file:
    file.write(str(all_ID_TRACKS))

"""

# with open("D:/ENEA_CAS_WORK/BRESCIA/all_idterms.txt", "r") as file:
#     all_ID_TRACKS = eval(file.readline())

## reload 'all_ID_TRACKS' as list
with open("D:/ENEA_CAS_WORK/BRESCIA/all_idterms_new.txt", "r") as file:
     all_ID_TRACKS = eval(file.readline())
...
if __name__ == '__main__':
    ...
    pool = mp.Pool(processes=45)     ## use 45 processors
    print("++++++++++++++++ POOL +++++++++++++++++", pool)
